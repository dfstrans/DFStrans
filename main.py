...
def get_args_parser():
    ...
    parser.add_argument(
        '--sequence_length', required = False, type=int, help='sequence length',default = 8000)
    parser.add_argument(
        '--n_channels', required = False, type=int, help='number of channels',default = 20)
    parser.add_argument(
        '--batch_size', required = False, type=int, help='batch size',default = 16)
    parser.add_argument(
        '--conv_filters', required = False, type=int, help='number of filters on each convolutional layer'
        ,default = 20)
    parser.add_argument(
        '--window_length', required = False, type=int, help='window length',default = 100)
    parser.add_argument(
        '--window_step', required = False, type=int, help='window step',default = 100)
    parser.add_argument(
        '--time_steps', required = False, type=int, help='number of windows in which the time series are divided',
        default = 80)
    parser.add_argument(
        '--learning_rate', required = False, type=float, help='sequence length',default = 0.00001)
    parser.add_argument(
        '--n_epochs', required = False, type=int, help='sequence length',default = 200)
    ...
    parser.add_argument( '--path_results_excell', required=False, type=str,default = 'Results.xlsx')
    ...
    parser.add_argument('--n_cv_folds', required = False, type=int, help='number cv folds',
        default = 5)
